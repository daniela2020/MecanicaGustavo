...
<html>
    ...
    <body>
        ...
        <section>
            <br><p><h2> Trabalhamos com uma linha completa de peças de ótima qualidade.</p> </h2><br>
            <br><p><h2> Parcelamos as peças nos cartões.</p> </h2> <br>
        </section>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item"><a class="page-link" href="Empresa.php">Anterior</a></li>
