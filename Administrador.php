...
<form>
 ...
 ------------------------------>
     ...
     <body>
        ...
        <br>
        <!--abaixo a serialização onde cd linha terá array serializado com os dados do formulário, vai adicionando
        os dados pessoais e abaixo apresenta os dados dp formulario em forma de tabela com os dados do formulario-->
        <?php
       ...
       <form action="Script_do_Formulario.php" method="post">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                <li class="page-item"><a class="page-link" href="Cadastro.php">Próximo</a></li>
            </ul>
        </nav>
